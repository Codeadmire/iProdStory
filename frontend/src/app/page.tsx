...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (crawlJob && (crawlJob.status === "Started" || crawlJob.status === "RUNNING" || crawlJob.status === "PENDING" || crawlJob.status === "QUEUED" || crawlJob.status === "queued")) {
                ...
                {showAdvanced && (
                  <div className="mt-4 bg-white/[0.02] p-4 rounded-xl inline-flex gap-4 border border-white/5 animate-in fade-in">
                    ...
                    <div>
                      ...
                      >
                        <option value="gemini-3.8-flash">Gemini 1.5 Flash (Fast)</option>
